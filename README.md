...
## 当前版本：P0.8 TestFlight 反馈修正

P0 原型验证核心体验：**"在手机上调一杯 Mojito，是否有趣、好看、可理解？"**
当前 `0.0.8 (8)` 已发布到 TestFlight，作为 P0.7 外部测试基线。现在进入 P0.8，聚焦首轮反馈修正、调酒台视觉层级、SpriteKit 调酒舞台重构和 Spec 驱动开发流程。
...
- 核心操作：长按倒料、量杯入杯、加冰、摇酒、出杯
- 评分系统及详细反馈
- 液体、量杯、冰块、气泡和杯具状态视觉呈现
- Mojito 核心材料贴图接入
- 中央调酒舞台开始从 SwiftUI 叠层迁移到 SpriteKit

### 技术栈

- SwiftUI
- SpriteKit（P0.8 起用于调酒主舞台）
- 原生 iOS（iOS 17.0+）
- Xcode
